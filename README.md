...
![Main menu](https://github.com/Sys-AxelFT/Degree2DegreeMinuteSecond-Conversor/blob/main/images/menu.png?raw=true)   
<br>   
You then choose an option.
First option converts degrees to radians, and thus receives a decimal or float input:   
![First option](https://github.com/Sys-AxelFT/Degree2DegreeMinuteSecond-Conversor/blob/main/images/one.png?raw=true)  
<br>
...
![Second option](https://github.com/Sys-AxelFT/Degree2DegreeMinuteSecond-Conversor/blob/main/images/two.png?raw=true)
<br>
